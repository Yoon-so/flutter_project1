...
import 'package:flutter_project1/screen/network/json_model.dart';
import 'package:flutter_project1/screen/network/member.dart';
import 'package:flutter_project1/screen/network/member_edit_screen.dart';
...
class _MemberListScreenState extends State<MemberListScreen> {
  ...
  Dio dio2 = Dio(
    BaseOptions(
      baseUrl: "https://online-lecture-data.s3.ap-northeast-2.amazonaws.com/data.json",
    ),
  );
